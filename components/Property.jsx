...
<Flex flexWrap='wrap' width='420px' p='5' paddingTop='0' justifyContent='start' cursor='pointer'>
<Box>
    <Image src={coverPhoto?coverPhoto.url : defaultImg} alt='house' width={400} height={250} />
</Box>
...
{rooms} <FaBed/> | {baths} <FaBath/> | {millify(area)} sqrf <BsGridFill/> 
